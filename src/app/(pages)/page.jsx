...
export default function ChatPage() {
    ...
    // Move showSidebar state to page level to avoid conflicts
    ...
    return (
        <div className="flex flex-col h-full w-full sm:px-20 sm:py-10 border bg-gray-300 text-gray-800 overflow-hidden justify-center items-center">
            <Toaster
                position="top-center"
                reverseOrder={false}
                toastOptions={{
