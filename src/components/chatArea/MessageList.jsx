    ...
    return (
        <>
            {chat.map((msg, i) => {
                ...
                return (
                    <div key={msg.id || i} className={`max-w-[85%] md:max-w-[70%] break-all h-auto min-w-[15%] p-3 rounded-2xl shadow-sm ${isOwnMessage ? 'ml-auto bg-[#00a884] text-white' : isDark ? 'mr-auto bg-gray-700 text-white border-gray-600' : 'mr-auto bg-white text-gray-800 border border-gray-200'}`}>
