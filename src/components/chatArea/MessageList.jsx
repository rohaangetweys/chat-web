    ...
    return (
        <div className="flex flex-col gap-3 p-4">
            {chat.map((msg, i) => {
                ...
                const showProfileInfo = msg.username !== username && activeChatType === 'group';
                ...
                return (
                    ...
                    >
                        <div className={`flex ${isOwnMessage ? 'flex-row-reverse' : 'flex-row'} items-end gap-2 max-w-[80%] md:max-w-[70%]`}>
                            ...
                            {showProfileInfo && (
                                <div className="flex flex-col items-center gap-1 mb-1 shrink-0">
                                    ...
                                    <p className="text-xs text-gray-500 max-w-[60px] truncate">{msg.username}</p>
                                </div>
                            )}

                            {/* Message Bubble */}
                            <div
                                className={`relative px-4 py-2 rounded-3xl text-sm leading-relaxed shadow
                                    ${isOwnMessage
                                        ? 'bg-[#0285ff] text-white rounded-tr-none'
                                        : isDark
