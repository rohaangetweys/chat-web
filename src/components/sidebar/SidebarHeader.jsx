        ...
        <>
            <div className={`p-4 ${isDark ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-200'} flex items-center gap-3 border-b shadow-sm`}>
                {getProfilePhoto(username) ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-[#0084ff] flex justify-center items-center text-white font-semibold shadow-md">
            ...
            <div className={`p-4 ${isDark ? 'bg-gray-800' : 'bg-white'} flex items-center justify-between gap-2`}>
                <div className="relative w-full">
                    ...
                    <input type="text" value={searchQuery} onChange={(e) => onSearchChange(e.target.value)} placeholder={"Search contacts..."} className={`w-full p-3 pl-12 rounded-full ${isDark ? 'bg-gray-700 text-white placeholder-gray-400 focus:ring-[#0084ff]' : 'bg-gray-100 text-gray-800 placeholder-gray-500 focus:ring-[#0084ff]'} focus:outline-none focus:ring-2 border-none shadow-inner`} />
                    {searchQuery && (
